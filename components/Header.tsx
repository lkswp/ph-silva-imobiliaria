  ...
  return (
    <motion.header
      ...
      className={cn(
        ...
        isScrolled
          ? "bg-background/80 backdrop-blur-xl border-white/10 shadow-glass py-1 lg:py-2"
          : "bg-transparent border-transparent py-2 lg:py-3"
      )}
    >
        ...
        <div className="flex items-center justify-between">
          ...
          >
            <Image
              ...
              width={140}
              height={35}
              className="w-28 md:w-32 lg:w-36 object-contain transition-transform duration-300 group-hover:scale-105"
              priority
            />
          </Link>
